!function (t, e) {
    ...
    function e(t) {
        ...
        return n && (i.firefox = !0, i.version = n[1]), r && (i.ie = !0, i.version = r[1]), a && (i.edge = !0, i.version = a[1]), o && (i.weChat = !0), {browser: i, os: e, node: !1, canvasSupported: !!document.createElement("canvas").getContext, svgSupported: "undefined" != typeof SVGRect, touchEventsSupported: "ontouchstart" in window && !i.ie && !i.edge, pointerEventsSupported: "onpointerdown" in window && (i.edge || i.ie && i.version >= 11), domSupported: "undefined" != typeof document}
    }
    ...
    function ye(t, e, i) {
        return {type: t, event: i, target: e.target, topTarget: e.topTarget, cancelBubble: !1, offsetX: i.zrX, offsetY: i.zrY, gestureEvent: i.gestureEvent, pinchX: i.pinchX, pinchY: i.pinchY, pinchScale: i.pinchScale, wheelDelta: i.zrDelta, zrByTouch: i.zrByTouch, which: i.which, stop: xe}
    }
    ...
    function ki(t, e, i, n, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                return a ? (e = a.image, !Li(e) && a.pending.push(o)) : (!e && (e = new Image), e.onload = e.onerror = Pi, bv.put(t, e.__cachedImgObj = {image: e, pending: [o]}), e.src = e.__zrImageSrc = t), e
            }
            return t
        }
        return e
    ...
    function ji(t, e, i, n) {
        ...
        if (i && (s += i[0] + i[2]), t && n) {
            ...
            if (null != l && s > l) t = "", a = []; else if (null != h) for (var u = Gi(h - (i ? i[1] + i[3] : 0), e, n.ellipsis, {minChar: n.minChar, placeholder: n.placeholder}), c = 0, d = a.length; d > c; c++) a[c] = Hi(a[c], u)
        }
    ...
    function qi(t, e) {
        ...
        for (var p = 0; p < o.length; p++) {
            for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
                ...
                if (w && (S += w[0] + w[2]), x.height = S, x.lineHeight = k(_.textLineHeight, e.textLineHeight, S), x.textAlign = _ && _.textAlign || e.textAlign, x.textVerticalAlign = _ && _.textVerticalAlign || "middle", null != f && s + x.lineHeight > f) return {lines: [], width: 0, height: 0};
    ...
    function Aa(t) {
        ...
        if (e && null == t.textFill) {
            ...
            n !== !1 && (n === !0 || e.isRectText && r && "string" == typeof r && r.indexOf("inside") >= 0) ? (i = {textFill: null, textStroke: t.textStroke, textStrokeWidth: t.textStrokeWidth}, t.textFill = "#fff", null == t.textStroke && (t.textStroke = a, null == t.textStrokeWidth && (t.textStrokeWidth = 2))) : null != a && (i = {textFill: null}, t.textFill = a), i && (t.insideRollback = i)
        }
    }
    ...
    function Va(t, e, i) {
        ...
        return i = i || {x: -1, y: -1, width: 2, height: 2}, t ? 0 === t.indexOf("image://") ? (n.image = t.slice(8), s(n, i), new yn(e)) : Qr(t.replace("path://", ""), e, i, "center") : void 0
    }
    ...
    function zo(t) {
        ...
        !c && l && (c = Fo(t, l, i, n, a, u)), Ox(t).source = new ko({data: i, fromDataset: r, seriesLayoutBy: a, sourceFormat: n, dimensionsDefine: u.dimensionsDefine, startIndex: u.startIndex, dimensionsDetectCount: u.dimensionsDetectCount, encodeDefine: c})
    }
    ...
    function Cs(t, e, i, n, r, a) {
        r_.reset(i, n, r, a), t._callingProgress = e, t._callingProgress({start: i, end: n, count: n - i, next: r_.next}, t.context)
    }
    ...
    function Bs() {
        this.group = new lv, this.uid = Za("viewChart"), this.renderTask = Is({plan: Vs, reset: Ws}), this.renderTask.context = {view: this}
    }
    ...
    function js(t, e, i, n, r) {
        function a(i) {
            ...
            s.context = {model: i, ecModel: n, api: r, useClearVisual: e.isVisual && !e.isLayout, plan: e.plan, reset: e.reset, scheduler: t}, nl(t, i, s)
        }
    ...
    function qs(t, e, i, n, r) {
        function a(e) {
            ...
            n || (n = s.set(i, Is({reset: $s, onDirty: Qs})), o.dirty()), n.context = {model: e, overallProgress: u, modifyOutputEnd: c}, n.agent = o, n.__block = u, nl(t, e, n)
        }
    ...
    function yl(t, e, i) {
        ...
        var a = "canvas", o = this._zr = On(t, {renderer: i.renderer || a, devicePixelRatio: i.devicePixelRatio, width: i.width, height: i.height});
    ...
    function Sl(t, e) {
        ...
        }, this), "none" === h || g || l || (this[lw] ? (_l(this), cw.update.call(this, t), this[lw] = !1) : cw[h].call(this, t)), d = c ? {type: a.event || i, escapeConnect: n, batch: f} : f[0], this[sw] = !1, !e && this._messageCenter.trigger(d.type, d)
    }
    ...
    function Ul(t, e, i) {
        ...
        t.event = (t.event || n).toLowerCase(), e = t.event, X_(hw.test(n) && hw.test(e)), fw[n] || (fw[n] = {action: i, actionInfo: t}), pw[e] = n
    }
    ...
    function jh(t) {
        ...
        if ("category" === i.type) {
            for (var r = i.getBandWidth(), a = 0; a < t.count; a++) e.push(s({bandWidth: r, axisKey: n, stackId: jw + a}, t));
    ...
    function Uh(t) {
        ...
        return f(t, function (t) {
            ...
            e.push({bandWidth: o, barWidth: s, barMaxWidth: l, barGap: h, barCategoryGap: u, axisKey: Yh(r), stackId: Xh(t)})
        }), $h(e)
    }
    ...
    function $h(t) {
        var e = {};
        f(t, function (t) {
            var i = t.axisKey, n = t.bandWidth, r = e[i] || {bandWidth: n, remainedWidth: n, autoWidthCount: 0, categoryGap: "20%", gap: "30%", stacks: {}}, a = r.stacks;
            e[i] = r;
            var o = t.stackId;
    ...
    function nu(t, e) {
        ...
        "ordinal" === a ? i = e.getCategories().length : (n = e.get("boundaryGap"), _(n) || (n = [n || 0, n || 0]), "boolean" == typeof n[0] && (n = [0, 0]), n[0] = Ua(n[0], 1), n[1] = Ua(n[1], 1), r = u[1] - u[0] || Math.abs(u[0])), null == o && (o = "ordinal" === a ? i ? 0 : 0 / 0 : u[0] - n[0] * r), null == s && (s = "ordinal" === a ? i ? i - 1 : 0 / 0 : u[1] + n[1] * r), "dataMin" === o ? o = u[0] : "function" == typeof o && (o = o({min: u[0], max: u[1]})), "dataMax" === s ? s = u[1] : "function" == typeof s && (s = s({min: u[0], max: u[1]})), (null == o || !isFinite(o)) && (o = 0 / 0), (null == s || !isFinite(s)) && (s = 0 / 0), t.setBlank(C(o) || C(s) || "ordinal" === a && !t.getOrdinalMeta().categories.length), e.getNeedCrossZero() && (o > 0 && s > 0 && !l && (o = 0), 0 > o && 0 > s && !h && (s = 0));
        var c = e.ecModel;
        if (c && "time" === a) {
            var d, p = qh("bar", c);
            if (f(p, function (t) {
    ...
    function au(t, e) {
        ...
        var o = t.type;
        t.setExtent(i[0], i[1]), t.niceExtent({splitNumber: a, fixMin: n, fixMax: r, minInterval: "interval" === o || "time" === o ? e.get("minInterval") : null, maxInterval: "interval" === o || "time" === o ? e.get("maxInterval") : null});
    ...
    function fu(t, e, i, n, r, a, o) {
        ...
        var l;
        return l = 0 === t.indexOf("image://") ? Jr(t.slice(8), new gi(e, i, n, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? Qr(t.slice(7), {}, new gi(e, i, n, r), o ? "center" : "cover") : new Mb({shape: {symbolType: t, x: e, y: i, width: n, height: r}}), l.__isEmptyBrush = s, l.setColor = du, l.setColor(a), l
    }
    ...
    function Iu(t, e) {
        ...
        if (r) return r;
        var a, o;
        return w(n) ? a = Eu(t, n) : (o = "auto" === n ? Pu(t) : n, a = zu(t, o)), ku(i, n, {labels: a, labelCategoryInterval: o})
    }
    ...
    function $u(t, e, i, n, r, a) {
        ...
        wa(t, e, o, s, {labelFetcher: r, labelDataIndex: a, defaultText: Uu(r.getData(), a), isRectText: !0, autoColor: n}), Ku(t), Ku(e)
    }
    ...
    function ac(t, e, i, n) {
        ...
        return no(o - Qb / 2) ? (a = l ? "bottom" : "top", r = "center") : no(o - 1.5 * Qb) ? (a = l ? "top" : "bottom", r = "center") : (a = "middle", r = 1.5 * Qb > o && o > Qb / 2 ? l ? "left" : "right" : l ? "right" : "left"), {rotation: o, textAlign: r, textVerticalAlign: a}
    }
    ...
    function cc(t, e, i) {
        ...
        if (e.get("axisTick.show") && !n.scale.isBlank()) {
            for (var r = e.getModel("axisTick"), a = r.getModel("lineStyle"), o = r.get("length"), l = n.getTicksCoords(), h = [], u = [], c = t._transform, d = [], f = 0; f < l.length; f++) {
                ...
                var g = new ky(ia({anid: "tick_" + l[f].tickValue, shape: {x1: h[0], y1: h[1], x2: u[0], y2: u[1]}, style: s(a.getLineStyle(), {stroke: e.get("axisLine.lineStyle.color")}), z2: 2, silent: !0}));
    ...
    function dc(t, e, i) {
        ...
        if (r && !n.scale.isBlank()) {
            ...
            return f(s, function (r, s) {
                ...
                ba(_.style, v, {text: f, textAlign: v.getShallow("align", !0) || h.textAlign, textVerticalAlign: v.getShallow("verticalAlign", !0) || v.getShallow("baseline", !0) || h.textVerticalAlign, textFill: "function" == typeof m ? m("category" === n.type ? g : "value" === n.type ? l + "" : l, s) : m}), p && (_.eventData = rc(e), _.eventData.targetType = "axisLabel", _.eventData.value = g), t._dumbGroup.add(_), _.updateTransform(), c.push(_), t.group.add(_), _.decomposeTransform()
            }), c
        }
    }
        ...
        iS(i.getCoordinateSystems(), function (i) {
            function s(n, s, l) {
                ...
                if (d && ("auto" !== d || n || bc(u))) {
                    ...
                    var f = u.get("snap"), p = Sc(l.model), g = s || f || "category" === l.type, v = t.axesInfo[p] = {key: p, axis: l, coordSys: i, axisPointerModel: u, triggerTooltip: s, involveSeries: g, snap: f, useHandle: bc(u), seriesModels: []};
    ...
    function Nc(t, e, i) {
        ...
        return (n |= Ph(e, d[0])) && (d[0] = f), (n |= Ph(e, d[1])) && (d[1] = f), {dataDimsForPoint: d, valueStart: o, valueAxisDim: l, baseAxisDim: s, stacked: !!n, valueDim: h, baseDim: u, baseDataOffset: c, stackedOverDimension: e.getCalculationInfo("stackedOverDimension")}
    }
    ...
    function Qc(t, e, i, n) {
        ...
        i && (o[0] -= .5, o[1] += .5);
        var h = new Sy({shape: {cx: $a(t.cx, 1), cy: $a(t.cy, 1), r0: $a(o[0], 1), r: $a(o[1], 1), startAngle: -s[0] * l, endAngle: -s[1] * l, clockwise: r.inverse}});
    ...
    function ed(t, e) {
        ...
        if (i && i.length && t.count() && "cartesian2d" === e.type) {
            ...
            if (r) {
                ...
                }), u.push({offset: c ? u[c - 1].offset : .5, color: d[1] || "transparent"}), u.unshift({offset: c ? u[0].offset : .5, color: d[0] || "transparent"});
    ...
    function fd(t) {
        var e, i = t.type;
        if ("path" === i) {
            var n = t.shape, r = null != n.width && null != n.height ? {x: n.x || 0, y: n.y || 0, width: n.width, height: n.height} : null, a = Id(n);
    ...
    function vd(t, e, i, n) {
        ...
        function l(i, n) {
            ...
            return null != s && (a.opacity = s), ba(a, x, null, {autoColor: w, isRectText: !0}), a.text = x.getShallow("show") ? D(t.getFormattedLabel(n, "normal"), Uu(e, n)) : null, i && o(a, i), a
        }
        ...
        var m, y, x, _, w, b = s({getWidth: n.getWidth, getHeight: n.getHeight, getZr: n.getZr, getDevicePixelRatio: n.getDevicePixelRatio, value: a, style: l, styleEmphasis: h, visual: u, barLayout: c, currentSeriesIndices: d, font: f}, v.api || {}), S = {context: {}, seriesId: t.id, seriesName: t.name, seriesIndex: t.seriesIndex, coordSys: v.coordSys, dataInsideLength: e.count(), encode: md(t.getData())}, M = !0;
        return function (t, i) {
            return m = t, M = !0, p && p(s({dataIndexInside: t, dataIndex: e.getRawIndex(t), actionType: i ? i.type : null}, S), b)
        }
    }
    ...
    function _d(t, e, i, n, r) {
        ...
        if (o || l || h) {
            if (l) return void wd({oldChildren: t.children() || [], newChildren: a || [], dataIndex: e, animatableModel: n, group: t, data: r});
            h && t.removeAll();
    ...
    function Dd(t, e) {
        ...
        var t = new Dy({shape: {x: t.x - i[3], y: t.y - i[0], width: t.width + i[1] + i[3], height: t.height + i[0] + i[2], r: e.get("borderRadius")}, style: n, silent: !0, z2: -1});
        return t
    }
    ...
    function af(t, e, i, n, r) {
        var a = i.get("value"), o = sf(a, e.axis, e.ecModel, i.get("seriesDataIndices"), {precision: i.get("label.precision"), formatter: i.get("label.formatter")}), s = i.getModel("label"), l = rx(s.get("padding") || 0), h = s.getFont(), u = Ei(o, h), c = r.position, d = u.width + l[1] + l[3], f = u.height + l[0] + l[2], p = r.align;
    ...
    function hf(t, e, i, n, r, a) {
        ...
        i.labelMargin = r.get("label.margin"), af(e, n, r, a, {position: lf(n.axis, t, i), align: o.textAlign, verticalAlign: o.textVerticalAlign})
    }
    ...
    function jf(t) {
        var e = t.hostModel;
        return {lineStyle: e.getModel("lineStyle").getLineStyle(), hoverLineStyle: e.getModel("emphasis.lineStyle").getLineStyle(), labelModel: e.getModel("label"), hoverLabelModel: e.getModel("emphasis.label")}
    }
    ...
    function np(t, e) {
        ...
        return "cartesian2d" === t.type && i && n && (ip(1, i, n, t) || ip(0, i, n, t)) ? !0 : Lf(t, {coord: i, x: e.x0, y: e.y0}) || Lf(t, {coord: n, x: e.x1, y: e.y1})
    }
    ...
    function Ap(t) {
        ...
        bg.call(this), this.setPointerChecker = function (t) {
            ...
            this.disable(), this._opt = s(n(h) || {}, {zoomOnMouseWheel: !0, moveOnMouseMove: !0, moveOnMouseWheel: !1, preventDefaultMouseMove: !0}), null == e && (e = !0), (e === !0 || "move" === e || "pan" === e) && (t.on("mousedown", i), t.on("mousemove", r), t.on("mouseup", a)), (e === !0 || "scale" === e || "zoom" === e) && (t.on("mousewheel", o), t.on("pinch", l))
    ...
    function kp(t) {
        if (!me(t) && Rp("moveOnMouseMove", t, this._opt) && this._dragging && "pinch" !== t.gestureEvent && !Tp(this._zr, "globalPan")) {
            ...
            this._x = e, this._y = i, this._opt.preventDefaultMouseMove && Ig(t.event), Ep(this, "pan", "moveOnMouseMove", t, {dx: a, dy: o, oldX: n, oldY: r, newX: e, newY: i})
        }
    }
    ...
    function Bp(t, e) {
        ...
        var a = i[r];
        a || (a = i[r] = {coordId: r, dataZoomInfos: {}, count: 0}, a.controller = Wp(t, a), a.dispatchAction = x(Hp, t)), !a.dataZoomInfos[n] && a.count++, a.dataZoomInfos[n] = e;
            ...
            i.on(t, function (i) {
                ...
                f(e.dataZoomInfos, function (r) {
                    if (i.isAvailableBehavior(r.dataZoomModel.option)) {
                        ...
                        !r.dataZoomModel.get("disabled", !0) && o && n.push({dataZoomId: r.dataZoomId, start: o[0], end: o[1]})
                    }
    ...
    Jp = "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? {browser: {}, os: {}, node: !1, wxa: !0, canvasSupported: !0, svgSupported: !1, touchEventsSupported: !0, domSupported: !1} : "undefined" == typeof document && "undefined" != typeof self ? {browser: {}, os: {}, node: !1, worker: !0, canvasSupported: !0, domSupported: !1} : "undefined" == typeof navigator ? {browser: {}, os: {}, node: !0, worker: !1, canvasSupported: !0, svgSupported: !0, domSupported: !1} : e(navigator.userAgent);
    var tg = Jp, eg = {"[object Function]": 1, "[object RegExp]": 1, "[object Date]": 1, "[object Error]": 1, "[object CanvasGradient]": 1, "[object CanvasPattern]": 1, "[object Image]": 1, "[object Canvas]": 1}, ig = {"[object Int8Array]": 1, "[object Uint8Array]": 1, "[object Uint8ClampedArray]": 1, "[object Int16Array]": 1, "[object Uint16Array]": 1, "[object Int32Array]": 1, "[object Uint32Array]": 1, "[object Float32Array]": 1, "[object Float64Array]": 1}, ng = Object.prototype.toString, rg = Array.prototype, ag = rg.forEach, og = rg.filter, sg = rg.slice, lg = rg.map, hg = rg.reduce, ug = {}, cg = function () {
    ...
    var Dg = "undefined" == typeof Float32Array ? Array : Float32Array, kg = (Object.freeze || Object)({create: be, identity: Se, copy: Me, mul: Ie, translate: Te, rotate: Ce, scale: Ae, invert: De, clone: ke}), Pg = Se, Lg = 5e-5, Og = function (t) {
    ...
    }, Xg = new Gg(20), Yg = null, jg = qe, qg = Ue, Ug = (Object.freeze || Object)({parse: He, lift: Ye, toHex: je, fastLerp: qe, fastMapToColor: jg, lerp: Ue, mapToColor: qg, modifyHSL: $e, modifyAlpha: Ke, stringify: Qe}), $g = Array.prototype.slice, Kg = function (t, e, i, n) {
    ...
    var dv = {shadowBlur: 1, shadowOffsetX: 1, shadowOffsetY: 1, textShadowBlur: 1, textShadowOffsetX: 1, textShadowOffsetY: 1, textBoxShadowBlur: 1, textBoxShadowOffsetX: 1, textBoxShadowOffsetY: 1}, fv = function (t, e, i) {
    ...
    _v.prototype = {
        constructor: _v, __dirty: !0, __used: !1, __drawIndex: 0, __startIndex: 0, __endIndex: 0, incremental: !1, getElementCount: function () {
            ...
            if (o && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(i, 0, 0, r / l, a / l)), n.clearRect(0, 0, r, a), e && "transparent" !== e) {
                var h;
                e.colorStops ? (h = e.__canvasGradient || gv.getGradient(n, e, {x: 0, y: 0, width: r, height: a}), e.__canvasGradient = h) : e.image && (h = xv.prototype.getCanvasPattern.call(e, n)), n.save(), n.fillStyle = h || e, n.fillRect(0, 0, r, a), n.restore()
            }
            if (o) {
                var u = this.domBack;
    ...
    var Ox = jn(), zx = "\x00_ec_inner", Ex = Wa.extend({
        init: function (t, e, i, n) {
            ...
            function e(t) {
                ...
                return !t || null == t[e] && null == t[i] && null == t[n] ? null : {mainType: r, index: t[e], id: t[i], name: t[n]}
            }
    ...
    var a_ = jn(), o_ = yx.extend({
        type: "series.__base__", seriesIndex: 0, coordinateSystem: null, defaultOption: null, legendDataProvider: null, visualColorAccessPath: "itemStyle.color", layoutMode: null, init: function (t, e, i) {
            this.seriesIndex = this.componentIndex, this.dataTask = Is({count: Ps, reset: Ls}), this.dataTask.context = {model: this}, this.mergeDefaultAndTheme(t, i), zo(this);
    ...
    var f_ = {
        ...
        toolbox: {brush: {title: {rect: "矩形选择", polygon: "圈选", lineX: "横向选择", lineY: "纵向选择", keep: "保持选择", clear: "清除选择"}}, dataView: {title: "数据视图", lang: ["数据视图", "关闭", "刷新"]}, dataZoom: {title: {zoom: "区域缩放", back: "区域缩放还原"}}, magicType: {title: {line: "切换为折线图", bar: "切换为柱状图", stack: "切换为堆叠", tiled: "切换为平铺"}}, restore: {title: "还原"}, saveAsImage: {title: "保存为图片", lang: ["右键另存为图片"]}},
        series: {typeNames: {pie: "饼图", bar: "柱状图", line: "折线图", scatter: "散点图", effectScatter: "涟漪散点图", radar: "雷达图", tree: "树图", treemap: "矩形树图", boxplot: "箱型图", candlestick: "K线图", k: "K线图", heatmap: "热力图", map: "地图", parallel: "平行坐标图", lines: "线图", graph: "关系图", sankey: "桑基图", funnel: "漏斗图", gauge: "仪表盘图", pictorialBar: "象形柱图", themeRiver: "主题河流图", sunburst: "旭日图"}},
        ...
        var i = new Dy({style: {fill: e.maskColor}, zlevel: e.zlevel, z: 1e4}), n = new Oy({shape: {startAngle: -__ / 2, endAngle: -__ / 2 + .1, r: 10}, style: {stroke: e.color, lineCap: "round", lineWidth: 5}, zlevel: e.zlevel, z: 10001}), r = new Dy({style: {fill: "none", text: e.text, textPosition: "right", textDistance: 10, textFill: e.textColor}, zlevel: e.zlevel, z: 10001});
        ...
        return a.add(n), a.add(r), a.add(i), a.resize = function () {
            ...
            var o = n.shape.r;
            r.setShape({x: e - o, y: a - o, width: 2 * o, height: 2 * o}), i.setShape({x: 0, y: 0, width: t.getWidth(), height: t.getHeight()})
        }, a.resize(), a
    }, b_ = Xs.prototype;
    b_.restoreData = function (t, e) {
        ...
        t.eachSeries(function (t) {
            ...
            i.set(r, {id: r, head: null, tail: null, threshold: t.getProgressiveThreshold(), progressiveEnabled: n && !(t.preventIncremental && t.preventIncremental()), blockIndex: -1, step: Math.round(n || 700), count: 0}), nl(e, t, t.dataTask)
        })
    ...
    Xs.wrapStageHandler = function (t, e) {
        return w(t) && (t = {overallReset: t, seriesType: rl(t)}), t.uid = Za("stageHandler"), e && (t.visualType = e), t
    };
    var I_, T_ = {}, C_ = {};
    ...
    var A_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"], D_ = {color: A_, colorLayer: [["#37A2DA", "#ffd85c", "#fd7b5f"], ["#37A2DA", "#67E0E3", "#FFDB5C", "#ff9f7f", "#E062AE", "#9d96f5"], ["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], A_]}, k_ = "#eee", P_ = function () {
        return {axisLine: {lineStyle: {color: k_}}, axisTick: {lineStyle: {color: k_}}, axisLabel: {textStyle: {color: k_}}, splitLine: {lineStyle: {type: "dashed", color: "#aaa"}}, splitArea: {areaStyle: {color: k_}}}
    }, L_ = ["#dd6b66", "#759aa0", "#e69d87", "#8dc1a9", "#ea7e53", "#eedd78", "#73a373", "#73b9bc", "#7289ab", "#91ca8c", "#f49f42"], O_ = {color: L_, backgroundColor: "#333", tooltip: {axisPointer: {lineStyle: {color: k_}, crossStyle: {color: k_}}}, legend: {textStyle: {color: k_}}, textStyle: {color: k_}, title: {textStyle: {color: k_}}, toolbox: {iconStyle: {normal: {borderColor: k_}}}, dataZoom: {textStyle: {color: k_}}, visualMap: {textStyle: {color: k_}}, timeline: {lineStyle: {color: k_}, itemStyle: {normal: {color: L_[1]}}, label: {normal: {textStyle: {color: k_}}}, controlStyle: {normal: {color: k_, borderColor: k_}}}, timeAxis: P_(), logAxis: P_(), valueAxis: P_(), categoryAxis: P_(), line: {symbol: "circle"}, graph: {color: L_}, gauge: {title: {textStyle: {color: k_}}}, candlestick: {itemStyle: {normal: {color: "#FD1050", color0: "#0CF49B", borderColor: "#FD1050", borderColor0: "#0CF49B"}}}};
    ...
    sl.prototype.parse = function (t, e) {
        ...
        return e.ignoreRootClip || null == a || null == o || n.setClipPath(new Dy({shape: {x: 0, y: 0, width: a, height: o}})), {root: n, width: a, height: o, viewBoxRect: l, viewBoxTransform: h}
        ...
        var r = new xy({style: {text: t.textContent, transformText: !0}, position: [this._textX || 0, this._textY || 0]});
    ...
    var R_ = {
        g: function (t, e) {
            ...
            var i = new Dy;
            return hl(e, i), cl(t, i, this._defs), i.setShape({x: parseFloat(t.getAttribute("x") || 0), y: parseFloat(t.getAttribute("y") || 0), width: parseFloat(t.getAttribute("width") || 0), height: parseFloat(t.getAttribute("height") || 0)}), i
        }, circle: function (t, e) {
            var i = new _y;
            return hl(e, i), cl(t, i, this._defs), i.setShape({cx: parseFloat(t.getAttribute("cx") || 0), cy: parseFloat(t.getAttribute("cy") || 0), r: parseFloat(t.getAttribute("r") || 0)}), i
        }, line: function (t, e) {
            var i = new ky;
            return hl(e, i), cl(t, i, this._defs), i.setShape({x1: parseFloat(t.getAttribute("x1") || 0), y1: parseFloat(t.getAttribute("y1") || 0), x2: parseFloat(t.getAttribute("x2") || 0), y2: parseFloat(t.getAttribute("y2") || 0)}), i
        }, ellipse: function (t, e) {
            var i = new z_;
            return hl(e, i), cl(t, i, this._defs), i.setShape({cx: parseFloat(t.getAttribute("cx") || 0), cy: parseFloat(t.getAttribute("cy") || 0), rx: parseFloat(t.getAttribute("rx") || 0), ry: parseFloat(t.getAttribute("ry") || 0)}), i
            ...
            var i = new yn;
            return hl(e, i), cl(t, i, this._defs), i.setStyle({image: t.getAttribute("xlink:href"), x: t.getAttribute("x"), y: t.getAttribute("y"), width: t.getAttribute("width"), height: t.getAttribute("height")}), i
        }, text: function (t, e) {
    ...
    }, N_ = {fill: "fill", stroke: "stroke", "stroke-width": "lineWidth", opacity: "opacity", "fill-opacity": "fillOpacity", "stroke-opacity": "strokeOpacity", "stroke-dasharray": "lineDash", "stroke-dashoffset": "lineDashOffset", "stroke-linecap": "lineCap", "stroke-linejoin": "lineJoin", "stroke-miterlimit": "miterLimit", "font-family": "fontFamily", "font-size": "fontSize", "font-style": "fontStyle", "font-weight": "fontWeight", "text-align": "textAlign", "alignment-baseline": "textBaseline"}, F_ = /url\(\s*#(.*?)\)/, V_ = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g, W_ = /([^\s:;]+)\s*:\s*([^:;]+)/g, G_ = N(), H_ = {
        registerMap: function (t, e, i) {
            var n;
            return _(e) ? n = e : e.svg ? n = [{type: "svg", source: e.svg, specialAreas: e.specialAreas}] : (e.geoJson && !e.features && (i = e.specialAreas, e = e.geoJson), n = [{type: "geoJSON", source: e, specialAreas: i}]), f(n, function (t) {
                var e = t.type;
    ...
    }, X_ = O, Y_ = f, j_ = w, q_ = S, U_ = yx.parseClassType, $_ = "4.2.0", K_ = {zrender: "4.0.5"}, Q_ = 1, J_ = 1e3, tw = 5e3, ew = 1e3, iw = 2e3, nw = 3e3, rw = 4e3, aw = 5e3, ow = {PROCESSOR: {FILTER: J_, STATISTIC: tw}, VISUAL: {LAYOUT: ew, GLOBAL: iw, CHART: nw, COMPONENT: rw, BRUSH: aw}}, sw = "__flagInMainProcess", lw = "__optionUpdated", hw = /^[a-zA-Z0-9_]+$/;
            ...
            if (bw[e]) {
                ...
                f(ww, function (a) {
                    if (a.group === e) {
                        ...
                        o = i(d.left, o), s = i(d.top, s), l = r(d.right, l), h = r(d.bottom, h), u.push({dom: c, left: d.left, top: d.top})
                    }
                }), o *= c, s *= c, l *= c, h *= c;
    ...
    var cw = {
        prepareAndUpdate: function (t) {
            ...
            if (e) {
                ...
                }), Al(e), this._scheduler.performVisualTasks(e, t, {setDirty: !0, dirtyMap: a}), Pl(i, e, n, t, a), Ll(e, this._api)
            }
        ...
        Y_(dw, function (t) {
            this._zr.on(t, function (e) {
                ...
                if (i) {
                    ...
                    i.event = e, i.type = t, this._ecEventProcessor.eventInfo = {targetEl: r, packedEvent: i, model: u, view: c}, this.trigger(t, i)
                }
            }, this)
    ...
    Jl(iw, m_), Yl(Ux), jl(tw, $x), eh("default", w_), Ul({type: "highlight", event: "highlight", update: "highlight"}, V), Ul({type: "downplay", event: "downplay", update: "downplay"}, V), Xl("light", D_), Xl("dark", O_);
    var Cw = {};
    uh.prototype = {
    ...
    var Aw = N(["tooltip", "label", "itemName", "itemId", "seriesName"]), Dw = S, kw = "undefined", Pw = "e\x00\x00", Lw = {"float": typeof Float64Array === kw ? Array : Float64Array, "int": typeof Int32Array === kw ? Array : Int32Array, ordinal: Array, number: Array, time: Array}, Ow = typeof Uint32Array === kw ? Array : Uint32Array, zw = typeof Uint16Array === kw ? Array : Uint16Array, Ew = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_chunkSize", "_chunkCount", "_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx"], Rw = ["_extent", "_approximateExtent", "_rawExtent"], Bw = function (t, e) {
        t = t || ["x", "y"];
    ...
    var Vw = function (t, e) {
        return e = e || {}, Ch(e.coordDimensions || [], t, {dimsDef: e.dimensionsDefine || t.dimensionsDefine, encodeDef: e.encodeDefine || t.encodeDefine, dimCount: e.dimensionsCount, generateCoord: e.generateCoord, generateCoordCount: e.generateCoordCount})
    };
    ...
    }), Ib = {isDimensionStacked: Ph, enableDataStack: kh, getStackedDimension: Lh}, Tb = (Object.freeze || Object)({createList: pu, getLayoutRect: bo, dataStack: Ib, createScale: gu, mixinAxisModelCommonMethods: vu, completeDimensions: Ch, createDimensions: Vw, createSymbol: fu}), Cb = 1e-8;
    xu.prototype = {
    ...
    var Ab = function (t) {
        return _u(t), p(v(t.features, function (t) {
            ...
            "Polygon" === i.type && r.push({type: "polygon", exterior: n[0], interiors: n.slice(1)}), "MultiPolygon" === i.type && f(n, function (t) {
    ...
    var Bb = {show: !0, zlevel: 0, z: 0, inverse: !1, name: "", nameLocation: "end", nameRotate: null, nameTruncate: {maxWidth: null, ellipsis: "...", placeholder: "."}, nameTextStyle: {}, nameGap: 15, silent: !1, triggerEvent: !1, tooltip: {show: !1}, axisPointer: {}, axisLine: {show: !0, onZero: !0, onZeroAxisIndex: null, lineStyle: {color: "#333", width: 1, type: "solid"}, symbol: ["none", "none"], symbolSize: [10, 15]}, axisTick: {show: !0, inside: !1, length: 5, lineStyle: {width: 1}}, axisLabel: {show: !0, inside: !1, rotate: 0, showMinLabel: null, showMaxLabel: null, margin: 8, fontSize: 12}, splitLine: {show: !0, lineStyle: {color: ["#ccc"], width: 1, type: "solid"}}, splitArea: {show: !1, areaStyle: {color: ["rgba(250,250,250,0.3)", "rgba(200,200,200,0.3)"]}}}, Nb = {};
    Nb.categoryAxis = r({boundaryGap: !0, deduplication: null, splitLine: {show: !1}, axisTick: {alignWithLabel: !1, interval: "auto"}, axisLabel: {interval: "auto"}}, Bb), Nb.valueAxis = r({boundaryGap: [0, 0], splitNumber: 5}, Bb), Nb.timeAxis = s({scale: !0, min: "dataMin", max: "dataMax"}, Nb.valueAxis), Nb.logAxis = s({scale: !0, logBase: 10}, Nb.valueAxis);
    ...
    r(Wb.prototype, vb);
    var Gb = {offset: 0};
    Vb("x", Wb, Wu, Gb), Vb("y", Wb, Wu, Gb), yx.extend({type: "grid", dependencies: ["xAxis", "yAxis"], layoutMode: "box", coordinateSystem: null, defaultOption: {show: !1, zlevel: 0, z: 0, left: "10%", top: 60, right: "10%", bottom: 60, containLabel: !1, backgroundColor: "rgba(0,0,0,0)", borderWidth: 1, borderColor: "#ccc"}});
    var Hb = Hu.prototype;
    ...
    var Ub = {
        ...
        this.opt = e, this.axisModel = t, s(e, {labelOffset: 0, nameDirection: 1, tickDirection: 1, labelDirection: 1, silent: !0}), this.group = new lv;
    ...
    var tS = {
        axisLine: function () {
            ...
            if (e.get("axisLine.show")) {
                ...
                this.group.add(new ky(ia({anid: "line", shape: {x1: r[0], y1: r[1], x2: a[0], y2: a[1]}, style: s, strokeContainThreshold: t.strokeContainThreshold || 5, silent: !0, z2: 1})));
                ...
                if ("number" == typeof u && (u = [u, u]), null != l) {
                    ...
                    var c = h[0], d = h[1];
                    f([{rotate: t.rotation + Math.PI / 2, offset: u[0], r: 0}, {rotate: t.rotation - Math.PI / 2, offset: u[1], r: Math.sqrt((r[0] - a[0]) * (r[0] - a[0]) + (r[1] - a[1]) * (r[1] - a[1]))}], function (e, i) {
            ...
            if (i) {
                ...
                ba(b.style, s, {text: y, textFont: p, textFill: s.getTextColor() || e.get("axisLine.lineStyle.color"), textAlign: n.textAlign, textVerticalAlign: n.textVerticalAlign}), e.get("triggerEvent") && (b.eventData = rc(e), b.eventData.targetType = "axisName", b.eventData.name = i), this._dumbGroup.add(b), b.updateTransform(), this.group.add(b), b.decomposeTransform()
            }
        }
    }, eS = Jb.innerTextLayout = function (t, e, i) {
        var n, r, a = io(e - t);
        return no(a) ? (r = i > 0 ? "top" : "bottom", n = "center") : no(a - Qb) ? (r = i > 0 ? "bottom" : "top", n = "center") : (r = "middle", n = a > 0 && Qb > a ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"), {rotation: a, textAlign: n, textVerticalAlign: r}
    }, iS = f, nS = x, rS = nh({
        ...
        type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, i, n) {
            ...
            if (!i.scale.isBlank()) {
                ...
                for (var o = e.coordinateSystem.getRect(), l = i.isHorizontal(), h = 0, u = i.getTicksCoords({tickModel: n}), c = [], d = [], f = r.getLineStyle(), p = 0; p < u.length; p++) {
                    ...
                    this._axisGroup.add(new ky(ia({anid: null != m ? "line_" + u[p].tickValue : null, shape: {x1: c[0], y1: c[1], x2: d[0], y2: d[1]}, style: s({stroke: a[v]}, f), silent: !0})))
                }
            }
            ...
            if (!i.scale.isBlank()) {
                ...
                if (l.length) {
                    ...
                    for (var f = 1; f < l.length; f++) {
                        ...
                        null != S && c.set(S, d), this._axisGroup.add(new Dy({anid: null != S ? "area_" + S : null, shape: {x: m, y: y, width: x, height: w}, style: s({fill: a[d]}, v), silent: !0})), d = (d + 1) % h
                    }
    ...
    lS.extend({type: "xAxis"}), lS.extend({type: "yAxis"}), nh({
        type: "grid", render: function (t) {
            this.group.removeAll(), t.get("show") && this.group.add(new Dy({shape: t.coordinateSystem.getRect(), style: s({fill: t.get("backgroundColor")}, t.getItemStyle()), silent: !0, z2: -1}))
        }
    }), Yl(function (t) {
    ...
    hS._updateCommon = function (t, e, i, n) {
        ...
        wa(y, u, f, p, {labelFetcher: s, labelDataIndex: e, defaultText: r, isRectText: !0, autoColor: l}), a.off("mouseover").off("mouseout").off("emphasis").off("normal"), a.hoverStyle = u, xa(a), a.__symbolOriginalScale = Ac(i), g && s.isAnimationEnabled() && a.on("mouseover", kc).on("mouseout", Pc).on("emphasis", Lc).on("normal", Oc)
    }, hS.fadeOut = function (t, e) {
        var i = this.childAt(0);
        this.silent = i.silent = !0, !(e && e.keepLabel) && (i.style.text = null), La(i, {style: {opacity: 0}, scale: [0, 0]}, this._seriesModel, this.dataIndex, t)
    }, u(Cc, lv);
    var gS = zc.prototype;
    ...
    var vS = function (t, e, i, n, r, a, o, s) {
        ...
        type: "ec-polygon", shape: {points: [], stackedOnPoints: [], smooth: 0, stackedOnSmooth: 0, smoothConstraint: !0, smoothMonotone: null, connectNulls: !1}, brush: by(Fr.prototype.brush), buildPath: function (t, e) {
    ...
    Bs.extend({
        type: "line", init: function () {
            ...
            var M = !u && t.get("step");
            f && c.type === n.type && M === this._step ? (m && !p ? p = this._newPolygon(h, _, n, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Jc(n, !1, !1, t)), w && d.updateData(a, {isIgnore: b, clipShape: Jc(n, !1, !0, t)}), a.eachItemGraphicEl(function (t) {
                t.stopAnimation(!0)
            }), jc(this._stackedOnPoints, _) && jc(this._points, h) || (v ? this._updateAnimation(a, _, n, i, M, y) : (M && (h = td(h, n, M), _ = td(_, n, M)), f.setShape({points: h}), p && p.setShape({points: h, stackedOnPoints: _})))) : (w && d.updateData(a, {isIgnore: b, clipShape: Jc(n, !1, !0, t)}), M && (h = td(h, n, M), _ = td(_, n, M)), f = this._newPolyline(h, n, v), m && (p = this._newPolygon(h, _, n, v)), g.setClipPath(Jc(n, !0, !1, t)));
            var I = ed(a, n) || a.getVisual("color");
            f.useStyle(s(o.getLineStyle(), {fill: "none", stroke: I, lineJoin: "bevel"}));
            var T = t.get("smooth");
            if (T = qc(t.get("smooth")), f.setShape({smooth: T, smoothMonotone: t.get("smoothMonotone"), connectNulls: t.get("connectNulls")}), p) {
                var C = a.getCalculationInfo("stackedOnSeries"), A = 0;
                p.useStyle(s(l.getAreaStyle(), {fill: I, opacity: .7, lineJoin: "bevel"})), C && (A = qc(C.get("smooth"))), p.setShape({smooth: T, stackedOnSmooth: A, smoothMonotone: t.get("smoothMonotone"), connectNulls: t.get("connectNulls")})
            }
            ...
            return e && this._lineGroup.remove(e), e = new MS({shape: {points: t}, silent: !0, z2: 10}), this._lineGroup.add(e), this._polyline = e, e
        }, _newPolygon: function (t, e) {
            var i = this._polygon;
            return i && this._lineGroup.remove(i), i = new IS({shape: {points: t, stackedOnPoints: e}, silent: !0}), this._lineGroup.add(i), this._polygon = i, i
            ...
            r && (u = td(h.current, i, r), c = td(h.stackedOnCurrent, i, r), d = td(h.next, i, r), f = td(h.stackedOnNext, i, r)), o.shape.__points = h.current, o.shape.points = u, La(o, {shape: {points: d}}, l), s && (s.setShape({points: u, stackedOnPoints: c}), La(s, {shape: {points: d, stackedOnPoints: f}}, l));
    ...
    var TS = function (t, e, i) {
        return {
            seriesType: t, performRawSeries: !0, reset: function (t, n) {
                ...
                if (a.setVisual({legendSymbol: i || o, symbol: o, symbolSize: s, symbolKeepAspect: l}), !n.isSeriesFiltered(t)) {
    ...
    var PS = function (t, e, i) {
        ...
        type: "series.pie", init: function (t) {
            ...
            for (var t = this.getRawData(), e = t.mapDimension("value"), i = [], n = 0, r = t.count(); r > n; n++) i.push({name: t.getName(n), value: t.get(e, n), selected: Ms(t, n, "selected")});
            return i
    ...
    zS.updateData = function (t, e, i) {
        ...
        a.useStyle(s({lineJoin: "bevel", fill: f}, h.getModel("itemStyle").getItemStyle())), a.hoverStyle = h.getModel("emphasis.itemStyle").getItemStyle();
        ...
        La(i, {shape: {points: s.linePoints || [[s.x, s.y], [s.x, s.y], [s.x, s.y]]}}, r, e), La(n, {style: {x: s.x, y: s.y}}, r, e), n.attr({rotation: s.rotation, origin: [s.x, s.y], z2: 10});
    ...
    var ES = (Bs.extend({
        ...
        o.each(function (i) {
            ...
            l = !!k, d.label = {x: n, y: h, position: g, height: L.height, len: m, len2: y, linePoints: u, textAlign: c, verticalAlign: "middle", rotation: k, inside: b}, b || s.push(d.label)
        ...
        e.eachSeriesByType(t, function (t) {
            ...
            if (e.each(n, function (t, i) {
                var n;
                if (isNaN(t)) return void e.setItemLayout(i, {angle: 0 / 0, startAngle: 0 / 0, endAngle: 0 / 0, clockwise: y, cx: h, cy: u, r0: c, r: x ? 0 / 0 : d});
                n = "area" !== x ? 0 === v && w ? m : t * m : NS / g, p > n ? (n = p, S -= p) : M += t;
                var r = I + T * n;
                e.setItemLayout(i, {angle: n, startAngle: I, endAngle: r, clockwise: y, cx: h, cy: u, r0: c, r: x ? qa(t, b, [c, d]) : d}), I = r
            }), NS > S && g) if (.001 >= S) {
                var C = NS / g;
    ...
    ES("pie", [{type: "pieToggleSelect", event: "pieselectchanged", method: "toggleSelected"}, {type: "pieSelect", event: "pieselected", method: "select"}, {type: "pieUnSelect", event: "pieunselected", method: "unSelect"}]), Jl(RS("pie")), Ql(x(VS, "pie")), jl(WS("pie"));
    var GS = function (t) {
        ...
        return {
            coordSys: {type: "calendar", x: e.x, y: e.y, width: e.width, height: e.height, cellWidth: t.getCellWidth(), cellHeight: t.getCellHeight(), rangeInfo: {start: i.start, end: i.end, weeks: i.weeks, dayCount: i.allDay}}, api: {
                coord: function (e, i) {
    ...
    }), ih({type: "title", layoutMode: {type: "box", ignoreSize: !0}, defaultOption: {zlevel: 0, z: 6, show: !0, text: "", target: "blank", subtext: "", subtarget: "blank", left: 0, top: 0, backgroundColor: "rgba(0,0,0,0)", borderColor: "#ccc", borderWidth: 0, padding: 5, itemGap: 10, textStyle: {fontSize: 18, fontWeight: "bolder", color: "#333"}, subtextStyle: {color: "#aaa"}}}), nh({
        type: "title", render: function (t, e, i) {
            if (this.group.removeAll(), t.get("show")) {
                var n = this.group, r = t.getModel("textStyle"), a = t.getModel("subtextStyle"), o = t.get("textAlign"), s = t.get("textBaseline"), l = new xy({style: ba({}, r, {text: t.get("text"), textFill: r.getTextColor()}, {disableBox: !0}), z2: 10}), h = l.getBoundingRect(), u = t.get("subtext"), c = new xy({style: ba({}, a, {text: u, textFill: a.getTextColor(), y: h.height + t.get("itemGap"), textVerticalAlign: "top"}, {disableBox: !0}), z2: 10}), d = t.get("link"), f = t.get("sublink"), p = t.get("triggerEvent", !0);
                ...
                }), l.eventData = c.eventData = p ? {componentType: "title", componentIndex: t.componentIndex} : null, n.add(l), u && n.add(c);
                ...
                var w = new Dy({shape: {x: g.x - x[3], y: g.y - x[0], width: g.width + x[1] + x[3], height: g.height + x[0] + x[2], r: t.get("borderRadius")}, style: _, silent: !0});
                na(w), n.add(w)
            }
        }
    });
    ...
    var tM = x, eM = f, iM = lv, nM = nh({
        type: "legend.plain", newlineDisabled: !1, init: function () {
            ...
            "string" == typeof S && S ? M = S.replace("{name}", null != t ? t : "") : "function" == typeof S && (M = S(t)), g.add(new xy({style: ba({}, v, {text: M, x: w, y: c / 2, textFill: p ? v.getTextColor() : d, textAlign: b, textVerticalAlign: "middle"})}));
            var I = new Dy({
    ...
    var aM = JS.extend({
        ...
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            ...
            function r(t, i) {
                var r = t + "DataIndex", l = Va(e.get("pageIcons", !0)[e.getOrient().name][i], {onclick: y(a._pageGo, a, r, e, n)}, {x: -s[0] / 2, y: -s[1] / 2, width: s[0], height: s[1]});
                l.name = t, o.add(l)
            }
            ...
            o.add(new xy({name: "pageText", style: {textFill: l.getTextColor(), font: l.getFont(), textVerticalAlign: "middle", textAlign: "center"}, silent: !0})), r("pageNext", 1)
        }, layoutInner: function (t, e, i) {
            ...
            n && r && n.setStyle("text", b(r) ? r.replace("{current}", o).replace("{total}", s) : r({current: o, total: s}))
    ...
    var wM = Kd.extend({
        makeElOption: function (t, e, i, n, r) {
            ...
            return n.labelMargin = i.get("handle.margin"), {position: lf(e.axis, t, n), rotation: n.rotation + (n.labelDirection < 0 ? Math.PI : 0)}
    ...
    }), Ul({type: "updateAxisPointer", event: "updateAxisPointer", update: ":updateAxisPointer"}, pM), ih({type: "tooltip", dependencies: ["axisPointer"], defaultOption: {zlevel: 0, z: 60, show: !0, showContent: !0, trigger: "item", triggerOn: "mousemove|click", alwaysShowContent: !1, displayMode: "single", renderMode: "auto", confine: !1, showDelay: 0, hideDelay: 100, transitionDuration: .4, enterable: !1, backgroundColor: "rgba(50,50,50,0.7)", borderColor: "#333", borderRadius: 4, borderWidth: 0, padding: 5, extraCssText: "", axisPointer: {type: "line", axis: "auto", animation: "auto", animationDurationUpdate: 200, animationEasingUpdate: "exponentialOut", crossStyle: {color: "#999", width: 1, type: "dashed", textStyle: {}}}, textStyle: {color: "#fff", fontSize: 14}}});
    ...
    mf.prototype = {
        ...
        constructor: yf, _enterable: !0, update: function () {
            ...
            for (var n = {}, r = t, a = "{marker", o = "|}", s = r.indexOf(a); s >= 0;) {
                ...
                n["marker" + h] = h.indexOf("sub") > -1 ? {textWidth: 4, textHeight: 4, textBorderRadius: 2, textBackgroundColor: e[h], textOffset: [3, 0]} : {textWidth: 10, textHeight: 10, textBorderRadius: 5, textBackgroundColor: e[h]}, r = r.substr(l + 1), s = r.indexOf("{marker")
            }
            this.el = new xy({style: {rich: n, text: t, textLineHeight: 20, textBackgroundColor: i.get("backgroundColor"), textBorderRadius: i.get("borderRadius"), textFill: i.get("textStyle.color"), textPadding: i.get("padding")}, z: i.get("z")}), this._zr.add(this.el);
            var u = this;
        ...
        type: "tooltip", init: function (t, e) {
            ...
            if (n.from !== this.uid && !tg.node) {
                ...
                if (n.tooltip && null != n.x && null != n.y) {
                    var o = kM;
                    o.position = [n.x, n.y], o.update(), o.tooltip = n.tooltip, this._tryShow({offsetX: n.x, offsetY: n.y, target: o}, r)
                    ...
                    null != l && null != h && this._tryShow({offsetX: l, offsetY: h, position: n.position, target: s.el, event: {}}, r)
            ...
            if (null != r && null != a && null != o) {
                ...
                if (s) {
                    ...
                    if ("axis" === t.get("trigger")) return i.dispatchAction({type: "updateAxisPointer", seriesIndex: r, dataIndex: a, position: n.position}), !0
                }
            }
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([i, n], a, r.el, d, {viewSize: [s, l], contentSize: h.slice()})), _(e)) i = DM(e[0], s), n = DM(e[1], l); else if (S(e)) {
    ...
    var PM = co, LM = po, OM = ih({
        type: "marker", dependencies: ["series", "grid", "polar", "geo"], init: function (t, e, i, n) {
            ...
            i || e.eachSeries(function (t) {
                ...
                }), s = new r(i, this, e), o(s, {mainType: this.mainType, seriesIndex: t.seriesIndex, name: t.name, createdBySelf: !0}), s.__hostSeries = t), void (t[a] = s)) : void (t[a] = null)
            }, this)
    ...
    c(OM, i_), OM.extend({type: "markPoint", defaultOption: {zlevel: 0, z: 5, symbol: "pin", symbolSize: 50, tooltip: {trigger: "item"}, label: {show: !0, position: "inside"}, itemStyle: {borderWidth: 2}, emphasis: {label: {show: !0}}}});
    ...
    BM.extend({
        type: "markPoint", updateTransform: function (t, e, i) {
            ...
            e.setData(h), Ef(e.getData(), t, n), h.each(function (t) {
                ...
                "function" == typeof n && (n = n(e.getRawValue(t), e.getDataParams(t))), h.setItemVisual(t, {symbolSize: n, color: i.get("itemStyle.color") || o.getVisual("color"), symbol: i.getShallow("symbol")})
    ...
    }), OM.extend({type: "markLine", defaultOption: {zlevel: 0, z: 5, symbol: ["circle", "arrow"], symbolSize: [8, 16], precision: 2, tooltip: {trigger: "item"}, label: {show: !0, position: "end"}, lineStyle: {type: "dashed"}, emphasis: {label: {show: !0}, lineStyle: {width: 3}}, animationEasing: "linear"}});
    ...
    GM.beforeUpdate = Gf, GM._createLine = function (t, e, i) {
        ...
        r.useStyle(s({strokeNoScale: !0, fill: "none", stroke: c, opacity: d}, a)), r.hoverStyle = o, f(WM, function (t) {
    ...
    var ZM = function (t, e, i, a) {
        ...
        if (!_(a) && ("min" === l || "max" === l || "average" === l || "median" === l || null != a.xAxis || null != a.yAxis)) {
            ...
            m >= 0 && "number" == typeof c && (c = +c.toFixed(Math.min(m, 20))), g.coord[f] = v.coord[f] = c, a = [g, v, {type: l, valueIndex: a.valueIndex, value: c}]
        }
    ...
    BM.extend({
        type: "markLine", updateTransform: function (t, e, i) {
            ...
            function r(e, i, r) {
                ...
                Jf(e, i, r, t, n), e.setItemVisual(i, {symbolSize: a.get("symbolSize") || g[r ? 0 : 1], symbol: a.get("symbol", !0) || p[r ? 0 : 1], color: a.get("itemStyle.color") || s.getVisual("color")})
            }
    ...
    }), OM.extend({type: "markArea", defaultOption: {zlevel: 0, z: 1, tooltip: {trigger: "item"}, animation: !1, label: {show: !0, position: "top"}, itemStyle: {borderWidth: 0}, emphasis: {label: {show: !0, position: "top"}}}});
    ...
    BM.extend({
        type: "markArea", updateTransform: function (t, e, i) {
            ...
            e.setData(u), u.each(function (e) {
                ...
                t.useStyle(s(n.getModel("itemStyle").getItemStyle(), {fill: Ke(o, .4), stroke: o})), t.hoverStyle = n.getModel("emphasis.itemStyle").getItemStyle(), wa(t.style, t.hoverStyle, r, a, {labelFetcher: e, labelDataIndex: i, defaultText: u.getName(i) || "", isRectText: !0, autoColor: o}), xa(t, {}), t.dataModel = e
    ...
    var qM = yx.extend({
        type: "timeline", layoutMode: "box", defaultOption: {zlevel: 0, z: 4, show: !0, axisType: "time", realtime: !0, left: "20%", top: null, right: "20%", bottom: 0, width: null, height: 40, padding: 5, controlPosition: "left", autoPlay: !1, rewind: !1, loop: !0, playInterval: 2e3, currentIndex: 0, itemStyle: {}, label: {color: "#000"}, data: []}, init: function (t, e, i) {
        ...
        type: "timeline.slider", defaultOption: {
            backgroundColor: "rgba(0,0,0,0)", borderColor: "#ccc", borderWidth: 0, orient: "horizontal", inverse: !1, tooltip: {trigger: "item"}, symbol: "emptyCircle", symbolSize: 10, lineStyle: {show: !0, width: 2, color: "#304654"}, label: {position: "auto", show: !0, interval: "auto", rotate: 0, color: "#304654"}, itemStyle: {color: "#304654", borderWidth: 1}, checkpointStyle: {symbol: "circle", symbolSize: 13, color: "#c23531", borderWidth: 5, borderColor: "rgba(194,53,49, 0.5)", animation: !0, animationDuration: 300, animationEasing: "quinticInOut"}, controlStyle: {
                show: !0,
                showPlayBtn: !0,
                showPrevBtn: !0,
                showNextBtn: !0,
                ...
                borderColor: "#304654",
                borderWidth: 1
            }, emphasis: {label: {show: !0, color: "#c23531"}, itemStyle: {color: "#c23531"}, controlStyle: {color: "#c23531", borderColor: "#c23531", borderWidth: 2}}, data: []
        }
    });
    c(UM, i_);
    ...
    $M.extend({
        type: "timeline.slider", init: function (t, e) {
            ...
            null == i || "auto" === i ? i = "horizontal" === n ? r.y + r.height / 2 < e.getHeight() / 2 ? "-" : "+" : r.x + r.width / 2 < e.getWidth() / 2 ? "+" : "-" : isNaN(i) && (i = {horizontal: {top: "-", bottom: "+"}, vertical: {left: "-", right: "+"}}[n][i]);
            ...
            return "left" === x || "bottom" === x ? (_ && (g = [0, 0], S += f), w && (v = [S, 0], S += f), b && (m = [M - c, 0], M -= f)) : (_ && (g = [M - c, 0], M -= f), w && (v = [0, 0], S += f), b && (m = [M - c, 0], M -= f)), y = [S, M], t.get("inverse") && y.reverse(), {viewRect: r, mainLength: l, orient: n, rotation: s[n], labelRotation: p, labelPosOpt: i, labelAlign: t.get("label.align") || a[n], labelBaseline: t.get("label.verticalAlign") || t.get("label.baseline") || o[n], playPosition: g, prevBtnPosition: v, nextBtnPosition: m, axisExtent: y, controlSize: c, controlGap: d}
            ...
            var r = i.getExtent();
            n.get("lineStyle.show") && e.add(new ky({shape: {x1: r[0], y1: 0, x2: r[1], y2: 0}, style: o({lineCap: "round"}, n.getModel("lineStyle").getLineStyle()), silent: !0, z2: 1}))
            ...
            if (r.get("show")) {
                ...
                JM(o, function (n) {
                    var r = n.tickValue, o = a.getItemModel(r), s = o.getModel("label"), l = o.getModel("emphasis.label"), h = i.dataToCoord(n.tickValue), u = new xy({position: [h, 0], rotation: t.labelRotation - t.rotation, onclick: QM(this._changeTimeline, this, r), silent: !1});
                    ba(u.style, s, {text: n.formattedLabel, textAlign: t.labelAlign, textVerticalAlign: t.labelBaseline}), e.add(u), xa(u, ba({}, l))
                }, this)
            }
        }, _renderControl: function (t, e, i, n) {
            function r(t, i, r, u) {
                if (t) {
                    var c = {position: t, origin: [a / 2, 0], rotation: u ? -o : 0, rectHover: !0, style: s, onclick: r}, d = up(n, i, h, c);
                    e.add(d), xa(d, l)
                }
            }
        ...
        constructor: oI, hostedBy: function (t) {
            ...
            return e.eachSeries(function (i) {
                if (fp(i.get("coordinateSystem"))) {
                    var n = this._dimName, r = e.queryComponents({mainType: n + "Axis", index: i.get(n + "AxisIndex"), id: i.get(n + "AxisId")})[0];
    ...
    var sI = f, lI = nI, hI = ih({
    ...
    }), cI = (hI.extend({type: "dataZoom.slider", layoutMode: "box", defaultOption: {show: !0, right: "ph", top: "ph", width: "ph", height: "ph", left: null, bottom: null, backgroundColor: "rgba(47,69,84,0)", dataBackground: {lineStyle: {color: "#2f4554", width: .5, opacity: .3}, areaStyle: {color: "rgba(47,69,84,0.3)", opacity: .3}}, borderColor: "#ddd", fillerColor: "rgba(167,183,204,0.4)", handleIcon: "M8.2,13.6V3.9H6.3v9.7H3.1v14.9h3.3v9.7h1.8v-9.7h3.3V13.6H8.2z M9.7,24.4H4.8v-1.4h4.9V24.4z M9.7,19.1H4.8v-1.4h4.9V19.1z", handleSize: "100%", handleStyle: {color: "#a7b7cc"}, labelPrecision: null, labelFormatter: null, showDetail: !0, showDataShadow: "auto", realtime: !0, zoomLock: !1, textStyle: {color: "#333"}}}), function (t, e, i, n, r, a) {
        ...
        type: "dataZoom.slider", init: function (t, e) {
            ...
            var t = this.dataZoomModel, e = this.api, i = this._findCoordRect(), n = {width: e.getWidth(), height: e.getHeight()}, r = this._orient === _I ? {right: n.width - i.x - i.width, top: n.height - xI - mI, width: i.width, height: xI} : {right: mI, top: i.y, width: xI, height: i.height}, a = Mo(t.option);
            f(["right", "top", "width", "height"], function (t) {
                "ph" === a[t] && (a[t] = r[t])
            });
            var o = bo(a, n, t.padding);
            this._location = {x: o.x, y: o.y}, this._size = [o.width, o.height], this._orient === wI && this._size.reverse()
            ...
            a.attr(i !== _I || r ? i === _I && r ? {scale: o ? [-1, 1] : [-1, -1]} : i !== wI || r ? {scale: o ? [-1, -1] : [-1, 1], rotation: Math.PI / 2} : {scale: o ? [1, -1] : [1, 1], rotation: Math.PI / 2} : {scale: o ? [1, 1] : [1, -1]});
            ...
            i.add(new dI({silent: !0, shape: {x: 0, y: 0, width: e[0], height: e[1]}, style: {fill: t.get("backgroundColor")}, z2: -40})), i.add(new dI({shape: {x: 0, y: 0, width: e[0], height: e[1]}, style: {fill: "transparent"}, z2: 0, onclick: y(this._onClickPanelClick, this)}))
            ...
            if (t) {
                ...
                if (null != r) {
                    ...
                    this._displayables.barGroup.add(new Cy({shape: {points: c}, style: s({fill: v.get("dataBackgroundColor")}, v.getModel("dataBackground.areaStyle").getAreaStyle()), silent: !0, z2: -20})), this._displayables.barGroup.add(new Ay({shape: {points: d}, style: v.getModel("dataBackground.lineStyle").getLineStyle(), silent: !0, z2: -19}))
                }
            }
                ...
                return t.eachTargetAxis(function (r, a) {
                    ...
                    f(o, function (t) {
                        if (!(i || e !== !0 && h(SI, t.get("type")) < 0)) {
                            ...
                            null != l && u.getOtherAxis && (o = u.getOtherAxis(s).inverse), l = t.getData().mapDimension(l), i = {thisAxis: s, series: t, thisDim: r.name, otherDim: l, otherAxisInverse: o}
                        }
                    }, this)
                }, this), i
            }
            ...
            n.add(t.filler = new dI({
            ...
            })), n.add(new dI(na({silent: !0, shape: {x: 0, y: 0, width: r[0], height: r[1]}, style: {stroke: a.get("dataBackgroundColor") || a.get("borderColor"), lineWidth: yI, fill: "rgba(0,0,0,0)"}}))), vI([0, 1], function (t) {
                ...
                this.group.add(i[t] = new xy({silent: !0, invisible: !0, style: {x: 0, y: 0, text: "", textVerticalAlign: "middle", textAlign: "center", textFill: l.getTextColor(), textFont: l.getFont()}, z2: 10}))
            }, this)
            ...
            function e(t) {
                ...
                r[t].setStyle({x: l[0], y: l[1], textVerticalAlign: a === _I ? "middle" : i, textAlign: a === _I ? i : "center", text: o[t]})
            }
    ...
    hI.extend({type: "dataZoom.inside", defaultOption: {disabled: !1, zoomLock: !1, zoomOnMouseWheel: !0, moveOnMouseMove: !0, moveOnMouseWheel: !1, preventDefaultMouseMove: !0}});
    ...
    if (!tg.canvasSupported) {
        ...
        var cT, dT = "normal", fT = {}, pT = 0, gT = 100, vT = document.createElement("div"), mT = function (t) {
            ...
            if (!e) {
                ...
                e = {style: n.fontStyle || dT, variant: n.fontVariant || dT, weight: n.fontWeight || dT, size: 0 | parseFloat(n.fontSize || 12), family: i || "Microsoft YaHei"}, fT[t] = e, pT++
            }
            return e
        };
        ...
        for (var yT = new gi, xT = function (t, e, i, n) {
            ...
            if (null != a && (a += ""), a) {
                ...
                sT(I, "fill", {fill: r.textFill, opacity: r.opacity}, this), sT(I, "stroke", {stroke: r.textStroke, opacity: r.opacity, lineDash: r.lineDash}, this), I.style.zIndex = eT(this.zlevel, this.z, this.z2), JI(t, I)
            }
        }, _T = function (t) {
